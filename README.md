...
L'idée est ensuite d'accéder aux expressions de $x^{(2)}$ (variable **D2X**) et $\phi^{(2)}$ (variable **D2PHI**) ne faisant intervenir que
les composantes du vecteur d'état $\vec{y}$ et la force $F$, via la fonction **solve** de **sympy**.
